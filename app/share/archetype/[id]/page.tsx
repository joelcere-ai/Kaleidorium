      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="text-center">
          ...
          <a 
            ...
            className="inline-block bg-[#6B57B8] border border-[#6B57B8] text-white font-bold px-8 py-3 rounded-lg font-semibold hover:bg-[#5A48A0] hover:border-[#5A48A0] hover:scale-[1.02] active:scale-95 transition-all"
          >
            Visit Kaleidorium
          </a>
        </div>
