  ...
  const ContactForm = () => {
    ...
    return (
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="font-sans bg-[#6B57B8] border border-[#6B57B8] text-white font-bold px-4 py-2 rounded text-sm hover:bg-[#5A48A0] hover:border-[#5A48A0] hover:scale-[1.02] active:scale-95 transition-all"
          disabled={loading}
                    ...
                    {activeCollection.map((artwork) => (
                      <Card key={artwork.id} className="overflow-hidden group hover:shadow-md transition-shadow">
                        ...
                        <CardContent className="p-4">
                          <h3 className="font-semibold text-gray-900 mb-0.5 truncate">{artwork.title}</h3>
                          <p className="text-sm text-gray-500 mb-3 truncate">{artwork.artist}</p>
                ...
                <div className="py-12 bg-gray-50">
                  <div className="container mx-auto px-4 max-w-4xl text-center">
                    ...
                    <Button
                      ...
                      className="bg-[#6B57B8] border border-[#6B57B8] text-white font-bold hover:bg-[#5A48A0] hover:border-[#5A48A0] hover:scale-[1.02] active:scale-95 transition-all px-8 py-2 text-sm font-medium"
                      style={{fontFamily: 'Arial, sans-serif'}}
                    >
